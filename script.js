// === VELN script.js: современный и расширенный ===
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById("ar-case-btn").onclick = () => {
        fetch("/ar_case").then(r=>r.json()).then(data=>{
            alert(data.message||"AR режим скоро!");
        }).catch(()=>alert("AR режим скоро!"));
    };
...
async function showTradeUI() {
    // Минималистичный интерфейс: выбрать юзера и предмет, отправить запрос
