// === VELN script.js: современный, фиксированный, с бургер-меню, красивой кнопкой, AR только в меню, плавная работа вкладок и топа, оптимизация для мобильных ===
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelectorAll('.veln-nav-btn').forEach(btn => {
        btn.onclick = () => {
            ...
            // Прокручиваем к началу вкладки для мобильных
